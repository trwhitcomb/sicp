...
(define (mul-case n x y)
  (cond ((= n 1) (make-interval (* (upper-bound x) (upper-bound y))
        ...
        ((= n 2) (make-interval (* (lower-bound x) (upper-bound y))
                                (* (lower-bound x) (lower-bound y))))
        ((= n 3) (make-interval (* (lower-bound x) (upper-bound y))
                                (* (upper-bound x) (lower-bound y))))
        ((= n 4) (make-interval (* (upper-bound x) (lower-bound y))
                                (* (lower-bound x) (lower-bound y))))
        ((= n 5) (make-interval (min (* (lower-bound x) (upper-bound y))
                                     (* (upper-bound x) (lower-bound y)))
                                (max (* (lower-bound x) (lower-bound y))
                                     (* (upper-bound x) (upper-bound y)))))
        ((= n 6) (make-interval (* (lower-bound x) (upper-bound y))
                                (* (upper-bound x) (upper-bound y))))
        ((= n 7) (make-interval (* (upper-bound x) (lower-bound y))
                                (* (lower-bound x) (upper-bound y))))
        ((= n 8) (make-interval (* (upper-bound x) (lower-bound y))
                                (* (upper-bound x) (upper-bound y))))
